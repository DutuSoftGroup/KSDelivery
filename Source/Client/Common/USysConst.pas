...
const
  ...
  cFI_FrameTruckLog     = $0012;                     //车辆通过记录
  cFI_FrameHYReaders    = $0013;                     //门岗读卡器
  cFI_FrameProvider     = $0014;                     //供应商
  ...
  cFI_FormTrucks        = $1011;                     //车牌号码
  cFI_FormMakeRFIDCard  = $1012;                     //办理电子标签
  cFI_FormHYReaders     = $1013;                     //车牌号码
  cFI_FormProvider      = $1014;                     //供应商
...
begin
  ...
  AddMenuModuleItem('MAIN_B02', cFI_FrameHYReaders);
  AddMenuModuleItem('MAIN_B03', cFI_FrameProvider);

  AddMenuModuleItem('MAIN_L01', cFI_FrameTruckLog);
end;
